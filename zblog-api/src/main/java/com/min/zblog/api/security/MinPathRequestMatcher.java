...
/**
 * 自定义RequestMatcher，参照AntPathRequestMatcher，实现序列化
 * @author zhouzm
 *
 */
public class MinPathRequestMatcher implements RequestMatcher, RequestVariablesExtractor, Serializable {
	private static final long serialVersionUID = -4942833381070333494L;
	
	private static final Logger logger = LoggerFactory.getLogger(MinPathRequestMatcher.class);
	 ...
	 */
	public MinPathRequestMatcher(String pattern) {
		this(pattern, null);
	}
	 ...
	 */
	public MinPathRequestMatcher(String pattern, String httpMethod) {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof MinPathRequestMatcher)) {
			return false;
		}

		MinPathRequestMatcher other = (MinPathRequestMatcher) obj;
	...
	private static class SpringAntMatcher implements Matcher, Serializable {
		private static final long serialVersionUID = 4359340783018206741L;

		private final MinPathMatcher antMatcher;
		...
		private static MinPathMatcher createMatcher(boolean caseSensitive) {
			MinPathMatcher matcher = new MinPathMatcher();
	 ...
	 */
	private static class SubpathMatcher implements Matcher, Serializable {
		private static final long serialVersionUID = -609333771448295437L;
