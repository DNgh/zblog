...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/fontawesome-iconpicker@1.4.1/dist/css/fontawesome-iconpicker.min.css">
  <!-- Ionicons -->
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							...
							<div class="input-group">
							    <input id="icon" data-placement="bottomRight"  data-input-search="true"  class="form-control icp icp-auto" value="${categoryInfo.icon}" type="text" />
...
<!-- Font Awesome Iconpicker -->
<script src="https://cdn.jsdelivr.net/npm/fontawesome-iconpicker@1.4.1/dist/js/fontawesome-iconpicker.min.js"></script>
<!-- FastClick -->
...
<script type="text/javascript">
	$(function(){
		...
		//初始化导航栏
		initNavBarStatus("categoryMenu", "editCategoryMenu");
