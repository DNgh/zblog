        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="https://cdn.jsdelivr.net/gh/DNgh/zblog-static/img/avatar.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><sec:authentication property="name"/></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="https://cdn.jsdelivr.net/gh/DNgh/zblog-static/img/avatar.png" class="img-circle" alt="User Image">
