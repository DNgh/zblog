    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="operateHst/queryPage"><i class="fa fa-circle-o"></i> 查询操作历史</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
		...
		layui.use('table', function(){
		  ...
		  allTable = table.render({
		    ...
		    ,cols: [[
		      ...
		      ,{field:'url', title:'请求路径', width:'10%'}
		      ,{field:'name', title:'操作类型', width:'10%'}
		      ,{field:'description', title:'操作详情', width:'20%'}
		      ,{field:'createTime', title:'操作时间', width:'20%', sort: true}
		    ]]
		    ,page: true
