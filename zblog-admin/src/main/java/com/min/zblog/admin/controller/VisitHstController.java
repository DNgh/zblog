...
@Controller
@RequestMapping("/visitHst")
public class VisitHstController {
	Logger logger = LoggerFactory.getLogger(getClass());
	
	@Autowired
	VisitHstService visitHstService;
	
	@RequestMapping("/queryPage")
    public ModelAndView queryPage(){
    	ModelAndView modelAndView =new ModelAndView("queryVisitHst");
    ...
    public Map<String, Object> query(@RequestParam(value="page")Integer page, 
    	...
    	PageInfo<VisitHstInfo> pageInfo = visitHstService.queryVisitHstByPage(limit, page, reqMap);
