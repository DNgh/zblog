        ...
        <div class="col-md-7">
            ...
            <div class="tab-content">
              <div class="active tab-pane">
                ...
                <div>
                  <h3>关于</h3>
                  <p>毕业于计算机专业，2016年开始从事Java软件开发，之前做过C语言嵌入式软件开发，用过java、spring、hibernate、gwt、drools、jquery、bootstrap、docker等等技术。</p>
                  <p>出于学习和总结开发技术的目的，搭建本博客，使用经典框架SSH实现后台，前台采用bootstrap框架。</p>
                </div>
